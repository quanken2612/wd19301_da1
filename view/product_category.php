...
<head>
    ...
    <link rel="stylesheet" href="public/css/product_category.css">
</head>
<body>
    <div class="khung">
        ...
        <div class="row mb body">
            <div class="boxtrai mb">
                <div class="row">
                    <div class="banner">
                        <img src="public/img/iPad-Pro-12.9-inch-2020-MacF5-Gray-1.jpg" alt="">
                    </div>
                </div>
                <div class="row">
                    <?php
                    ...
                    ?>
                        <div class="boxsp">
                            ...
                            <a href="?action=product_detail&id=<?php echo $product['id']; ?>&view=<?php echo $product['so_luot_xem']; ?>"><?php echo $product['ten_hh']; ?></a>
                        </div>
